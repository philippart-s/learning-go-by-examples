...
import (
    ...
    "github.com/philippart-s/learning-go-by-examples/go-rest-api/pkg/swagger/server/restapi"

    "github.com/philippart-s/learning-go-by-examples/go-rest-api/pkg/swagger/server/restapi/operations"
)
